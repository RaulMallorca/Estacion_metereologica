...
const long _1Hora = 6 * 10010;
const long _24Horas = 6 * 3 * 10010;
...
void getRain(void)
   {   
    ...
    if (current_millis_Lluvia - previous_millis_Lluvia1h >= _1Hora) //Reset precipitación 1h ///---(Actualmente 20 segundos)\\\---
    {      
      Serial.println("Reset lluvia 1 hora");
      Contador1h = 0; //reset  contador precipitación 1h
      previous_millis_Lluvia1h = millis();
    } 
    if ((current_millis_Lluvia - previous_millis_Lluvia24h >= _1Hora) && (current_millis_Lluvia - previous_millis_Lluvia24h >= _24Horas))    //Reset precipitación 24h ///---(Actualmente 60 segundos)\\\---
    {
