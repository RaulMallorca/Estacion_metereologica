...
/*---DESCOMENTAR PARA COMPROBAR QUE FUNCIONA OTA 1/3-----*/
//int led = D3;
/*-----------------FIN DESCOMENTAR 1/3-------------------*/

void setup() {

  /*---DESCOMENTAR PARA COMPROBAR QUE FUNCIONA OTA 2/3----*/
  //pinMode (led, OUTPUT);
  /*-----------------FIN DESCOMENTAR 2/3------------------*/
  ...
  InitOTA();  //Ajustes como puerto, password, etc (ESP8266_Utils_OTA.h)
...
void loop() {
  ...
  /*---DESCOMENTAR PARA COMPROBAR QUE FUNCIONA OTA 3/3----*/
